...
import com.ntan.swingy.models.vilains.Vilain;
...
public class Cell {
    ...
    public Cell(Integer id, Cell top, Cell right, Cell bottom, Cell left, Integer x, Integer y, Vilain vilain,
            Hero hero, boolean isExit) {
        this.id = id;
        this.top = top;
        this.right = right;
        this.bottom = bottom;
